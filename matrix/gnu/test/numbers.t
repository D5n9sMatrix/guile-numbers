...
$meta->add_type(
    ...
    constraint_generator => sub {
        ...
        Type::Tiny->new(
            ...
            parent     => $self,
            library    => __PACKAGE__,
            constraint => __real_constraint_generator($digits, $_NumRange_param),
            inlined    => __real_inline_generator    ($digits, $_NumRange_param),
        );
    },
);
...
$meta->add_type(
    ...
    constraint_generator => sub {
        ...
        Type::Tiny->new(
            ...
            parent     => $self,
            library    => __PACKAGE__,
            constraint => __real_constraint_generator($digits, $_NumRange_param, 1),
            inlined    => __real_inline_generator    ($digits, $_NumRange_param, 1),
        );
    },
);
